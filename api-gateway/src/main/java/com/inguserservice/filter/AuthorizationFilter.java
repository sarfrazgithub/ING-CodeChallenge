...
import static com.inguserservice.constants.FilterConstants.*;
...
import com.inguserservice.models.UrlPatternTree;
import com.inguserservice.models.UrlPatternTreeNode;
...
public class AuthorizationFilter extends ZuulFilter{
	...
	public Object run() throws ZuulException {
		...
		if (claimNode.isPresent()) {
			...
			throw new ZuulException("Invalid Token", HttpStatus.FORBIDDEN.value(), "Please verify the path and user id. User id should be numeric");
		}
	...
	@SuppressWarnings("unused") // Not validating user id
